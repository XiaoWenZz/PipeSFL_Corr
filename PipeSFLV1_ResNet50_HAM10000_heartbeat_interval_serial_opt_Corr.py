...
if __name__ == '__main__':
    ...
    acc_train_filename = os.path.join(acc_dir, f'PipeSFLV1_Corr_ResNet50_HAM10000_Client_ep{args.epochs}_ep{args.epochs}_dp{args.disconnect_prob:.2f}_' + time.strftime("%Y%m%d%H%M%S",
                                                                                                        time.localtime()) + '.csv')

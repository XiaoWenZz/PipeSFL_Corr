...
if __name__ == '__main__':
    ...
    plt.grid(True)
    prefix = f"_CIFAR10_constant_alpha_ep{args.epochs}_dp{args.disconnect_prob:.2f}_dr{args.disconnect_round}_le{args.local_ep}_lr{args.lr}_noniid{args.noniid_fraction:.2f}"
